...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/health/medications/{medication}/taken', [HealthDisciplineController::class, 'markMedicationTaken'])->name('health.medications.taken');
    Route::post('/health/medications/{medication}/skip', [HealthDisciplineController::class, 'skipMedication'])->name('health.medications.skip');
    Route::post('/health/medications/{medication}/snooze', [HealthDisciplineController::class, 'snoozeMedication'])->name('health.medications.snooze');
    Route::post('/health/medication-doses/{doseLog}/taken', [HealthDisciplineController::class, 'markDoseTaken'])->name('health.medication-doses.taken');
    Route::post('/health/medication-doses/{doseLog}/skip', [HealthDisciplineController::class, 'skipDose'])->name('health.medication-doses.skip');
    Route::post('/health/medication-doses/{doseLog}/snooze', [HealthDisciplineController::class, 'snoozeDose'])->name('health.medication-doses.snooze');
    Route::post('/health/workouts', [HealthDisciplineController::class, 'storeWorkout'])->name('health.workouts.store');
    Route::post('/health/workouts/{workoutLog}/complete', [HealthDisciplineController::class, 'completeWorkout'])->name('health.workouts.complete');
    Route::post('/health/workouts/{workoutLog}/skip', [HealthDisciplineController::class, 'skipWorkout'])->name('health.workouts.skip');
